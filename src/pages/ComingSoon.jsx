    ...
    <section className="relative overflow-hidden">
      ...
      <div className="lg:px-0 relative h-100 dark:bg-dark bg-white flex flex-col items-center justify-center">
        <div className="w-fit lg:text-start text-center">
          ...
          <button className="mt-5 hover:bg-alternate hover:text-white dark:hover:bg-white hover:dark:text-black gap-2 flex flex-row items-center justify-center w-full">
