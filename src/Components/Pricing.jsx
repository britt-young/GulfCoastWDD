...
const Pricing = () => {
  ...
  return (
    <section className="bg-white dark:bg-dark py-5 h-full">
      <div className="bg-alternate dark:bg-alternate/30 shadow-lg shadow-gray-400 dark:shadow-none py-12 lg:pt-24 mx-5 lg:mx-40 lg:px-0 rounded-2xl relative isolate overflow-hidden transform transition-all duration-300 group">
        ...
        {/* Pricing Cards */}
        <div className="relative mx-auto max-w-7xl grid grid-cols-1 mt-15 gap-y-9 lg:grid-cols-3 lg:gap-8 lg:pb-24 px-4 xl:px-0">
          {tiers.map((tier) => (
            <div
              key={tier.id}
