...
return (
  <section className="relative px-5 py-25 overflow-hidden">
    ...
    {/* Content */}
    <div className="relative pt-10 px-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-5 lg:gap-10 text-black">
      {/* Image */}
      ...
      <div className="flex flex-col items-start">
        ...
        <h2 className="dark:text-white">Websites starting at $145 per month</h2>
        <p className="mt-5">
