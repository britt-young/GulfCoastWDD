...
import pic from "../assets/imgs/homeabout.png";
import AOS from "aos";
      ...
      <div className="relative pt-40 pb-20 px-5 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-15 text-black">
        ...
        <div className="w-full flex items-center justify-center ">
          <img
            ...
            className="w-[200px] md:w-fit lg:h-185 md:h-140 h-100 object-cover outline-2 outline-offset-1 outline-white rounded-2xl shadow-lg"
          />
        </div>
        ...
        <div className="flex flex-col items-start dark:text-white">
          ...
          <h2 className="">Websites starting at $0 down, $200 per month</h2>
          <p className="mt-5">
