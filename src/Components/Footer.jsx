...
const Footer = () => {
  ...
  return (
    <div className="bg-white grid grid-cols-1 lg:grid-cols-2 p-10 lg:px-80 lg:gap-40 gap-20 z-0">
      ...
      <div className="flex flex-col lg:items-start py-5 lg:order-last order-first">
        <h4 className="mb-4 text-2xl border-l-6 border-alternate pl-2">Contact Us</h4>
        <div>
