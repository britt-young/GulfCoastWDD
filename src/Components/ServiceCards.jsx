  ...
  return (
    <div className="relative bg-white isolate px-6 py-24 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-3 lg:gap-x-2 lg:gap-y-20 gap-0 lg:pb-10 lg:pt-15 p-0">
        ...
        <TbDeviceMobileStar className="rounded-lg bg-[#cde9dc] p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
        ...
        {/* Feature Card */}
        <div className="bg-gray-50 h-fit m-2 mt-20 lg:mt-0 p-8 shadow-lg shadow-gray-500 rounded-lg flex flex-col relative">
        <GiSpeedometer className="rounded-lg bg-[#cde9dc] p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
        ...
        {/* Feature Card */}
        <div className="bg-gray-50 h-fit m-2 mt-20 lg:mt-0 p-8 shadow-lg shadow-gray-500 rounded-lg flex flex-col relative">
        <LiaLaptopCodeSolid className="rounded-lg bg-[#cde9dc] p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
        ...
        {/* Feature Card */}
        <div className="bg-gray-50 h-fit m-2 mt-20 lg:mt-0 p-8 shadow-lg shadow-gray-500 rounded-lg flex flex-col relative">
        <GiEarthAmerica className="rounded-lg bg-[#cde9dc] p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
        ...
        {/* Feature Card */}
        <div className="bg-gray-50 h-fit m-2 mt-20 lg:mt-0 p-8 shadow-lg shadow-gray-500 rounded-lg flex flex-col relative">
        <ImEmbed2 className="rounded-lg bg-[#cde9dc] p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
            <h4 className="mt-5">Mobile First Design</h4>
            <p className="mt-2 mb-3">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis
