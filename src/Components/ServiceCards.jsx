...
const ServiceCards = () => {
  ...
  return (
    <div className="bg-gray-200 dark:bg-mainb-dark/80 relative px-6 py-24 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-3 lg:gap-x-2 lg:gap-y-20 gap-0 lg:pb-10 lg:pt-15 p-0">
        {/* Feature Card */}
        <div className="card">
        <TbDeviceMobileStar className="text-white dark:text-white bg-main dark:bg-alt-dark rounded-lg p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
        ...
        {/* Feature Card */}
        <div className="card">
        <GiSpeedometer className="text-white dark:text-white bg-main dark:bg-alt-dark rounded-lg p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
        ...
        {/* Feature Card */}
        <div className="card">
        <LiaLaptopCodeSolid className="text-white dark:text-white bg-main dark:bg-alt-dark rounded-lg p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
        ...
        {/* Feature Card */}
        <div className="card">
        <GiEarthAmerica className="text-white dark:text-white bg-main dark:bg-alt-dark rounded-lg p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
        ...
        {/* Feature Card */}
        <div className="card">
        <ImEmbed2 className="text-white dark:text-white bg-main dark:bg-alt-dark rounded-lg p-4 w-20 h-20 mb-4 absolute transform -translate-x-0.5 -top-11" />
          <div className="my-2 items-start justify-start">
            <h4 className=" mt-5">Mobile First Design</h4>
            <p className=" mt-2 mb-3">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis
