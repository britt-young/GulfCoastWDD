...
const HomeHeader = () => {
  return (
    <div className="grid lg:grid-cols-12 gap-8 grid-cols-1 h-[750px] lg:m-0 m-5">
      <div className="h-full lg:col-span-3 lg:col-start-3 col-span-12 bg-transparent items-center lg:items-start justify-center flex flex-col">
      ...
      <div className="lg:col-span-5 col-span-12 bg-transparent flex items-center justify-center">
        <picture>
          <img
